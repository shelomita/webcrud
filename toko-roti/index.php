...
<div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjIXTg5OoPizy2CPmqtCCM907pO3kDd5n-2dDVxzcTNRSUGtkRPubXJwVAPSakE-i4IUo&usqp=CAU" style="width: 100%;  height: 650px;">
	</div>
</div>
<br>
<br>
...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #ff8d87; border-bottom: 2px solid #ff8d87;">
			Anda pecinta kuliner Jepang? Tapi tak punya waktu untuk mengunjungi restaurant Jepang? Checkout aja di toko kami.
		</h4>
